...
while run:
    ...
    for point in points:
        ...
        z = scale / (distance - translated_2d[2][0])
        projection_matrix = [[z, 0, 0, cube_position[0]],
                             [0, z, 0, cube_position[1]]]
        #projection_matrix = [[z, 0, 0, 0],
        #                    [0, z, 0, 0]]

        projected_2d = matrix_multiplication(projection_matrix, translated_2d)
        x, y = projected_2d[0][0], projected_2d[1][0]
        print(x, y)
